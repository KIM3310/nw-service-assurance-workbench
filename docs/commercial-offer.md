# Commercial Offer - NW Service Assurance Workbench
...
| Entry price assumption | $5k-$15k workshop |
...
| Outage review board | $20k-$60k pilot | Build MSP one-pager |
...
- Lead with the buyer's workflow: "For Telecom operations, IDC/network teams, MSPs, and enterprise network owners, the hard part is often moving from proof to operating handoff without creating new risk."
- Use the proof hook: "I can show the first proof artifact (npm run verify passes), then map it to one workflow you already own."
- Use the metric hook: "The first scorecard can focus on MTTR narrative quality, not a vague AI transformation claim."
