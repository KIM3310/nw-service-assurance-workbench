# Service Growth Model - nw-service-assurance-workbench
...
| Field | Decision |
|---|---|
| Service type | Network service assurance |
| Primary reader or buyer | NOC, IDC, telecom, and enterprise network teams. |
| Wedge | Service assurance workflow review with synthetic outage replay. |
