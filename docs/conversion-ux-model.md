# Conversion UX Model - NW Service Assurance Workbench
...
| Primary buyer or user | Telecom operations, IDC/network teams, MSPs, and enterprise network owners. |
| Value wedge | Service assurance board for access/core/transport incidents, SLA posture, and operator handoff. |
...
- Pilot: Outage review board ($20k-$60k pilot) using buyer-approved data and named operators.
...
- Put MTTR narrative quality on the pilot scorecard.
