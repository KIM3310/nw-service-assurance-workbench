# Service Architecture - nw-service-assurance-workbench
...
Static/Workers UI, API adapter layer for telemetry, Postgres/Timescale-compatible store for event history, object storage for reports.
...
- telemetry adapter tokens when connected
- DATABASE_URL
