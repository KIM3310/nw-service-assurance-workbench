...
|---|---|
| NOC workbench pilot | Scope after stakeholder intake |
| Outage review board | operator-approved implementation diagnostic |
| SLA reporting prototype | Scope after stakeholder intake |
