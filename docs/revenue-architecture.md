# Revenue Architecture - nw-service-assurance-workbench
...
| Repo-specific launch path | Cloudflare Workers canonical app/API, Cloudflare Pages alternate preview lane, D1/KV service state, R2 report bundles, OpenRouter/Groq for incident narratives |
